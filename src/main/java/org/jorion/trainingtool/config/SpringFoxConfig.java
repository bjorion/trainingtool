 ...
 * See
 * <ul>
 * <li>{@code https://springfox.github.io/springfox/docs/current/}
 * <li>{@code https://swagger.io/docs/specification/api-host-and-base-path/}
 * <li>{@code https://www.baeldung.com/swagger-2-documentation-for-spring-rest-api}
 * </ul>
 * <p>
 * This application JSON file:
 * <ul>
 * <li>v2 (Swagger 2): {@code http://localhost:8080/trainingtool/v2/api-docs}
 * <li>v3 (OpenApi 3): {@code http://localhost:8080/trainingtool/v3/api-docs}
 * </ul>
 */
@Configuration
public class SpringFoxConfig
{
    ...
    /**
     * For Basic Authentication: {@code https://swagger.io/docs/specification/authentication/basic-authentication/}
     *
