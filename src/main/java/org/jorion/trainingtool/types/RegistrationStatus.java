...
/**
 * Enumeration of the registration statuses.
 */
public enum RegistrationStatus
{
    ...
    SUBMITTED_TO_TRAINING("Submitted to Training", Role.TRAINING, 4),

    REFUSED_BY_TRAINING("Refused by Training", Role.TRAINING, 0),
    ...
    public static final EnumSet<RegistrationStatus> REFUSED_SET = EnumSet.of(REFUSED_BY_MANAGER, REFUSED_BY_HR, REFUSED_BY_TRAINING, REFUSED_BY_PROVIDER);

    public static final EnumSet<RegistrationStatus> APPROVED_SET = EnumSet.of(APPROVED_BY_PROVIDER);

    public static final EnumSet<RegistrationStatus> PENDING_SET = EnumSet.of(DRAFT, SUBMITTED_TO_MANAGER, SUBMITTED_TO_HR, SUBMITTED_TO_TRAINING,
    ...
    // --- Methods ---
    RegistrationStatus(String title, Role role, int step)
    {
        this.title = title;
    ...
    public RegistrationStatus getNextStatusAfterRefusal()
    {
        ...
        RegistrationStatus nextStatus = null;
        switch (this) {
