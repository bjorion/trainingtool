...
-- Training
INSERT INTO trainingtool.training (created_by, created_on, modified_on, enabled, enabled_from, enabled_until, provider, provider_other, title, description, url, price, start_date, end_date, period, total_hour, location, self_study, motivation)
