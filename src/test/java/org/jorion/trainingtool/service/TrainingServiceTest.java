...
public class TrainingServiceTest {
    ...
    void testFindAllTrainings_availableOnly() {
        ...
        when(mockTrainingRepository.findAvailableTrainings(any())).thenReturn(new ArrayList<Training>());
    ...
    void testFindAllTrainings_availableOrNot() {
        ...
        when(mockTrainingRepository.findAll()).thenReturn(new ArrayList<Training>());
